...
function cTAKESPanel(responseText, checkAjax) {
	...
	var tempFileIndex = openFileIndex;
        console.log("TempFileIndex: ",tempFileIndex);
				...
				.ajax(
						{
							...
							success : function(result) {
								...
								/*for (var tempFileIndex = 0; tempFileIndex < filesArray.length; tempFileIndex++) {
									...
									console.log($.trim(fileContent));
									console.log("Files array:");
									console.log($.trim(filesArray[tempFileIndex]["studyText"]));
									console.log("Equality:");
									console.log($.trim(filesArray[tempFileIndex]["studyText"]) == $.trim(fileContent));
									console.log("Type of (removed):");
									console.log(typeof filesArray[tempFileIndex]["removed"]);
									console.log("Type of (ctakesReturned):");
									console.log(typeof filesArray[tempFileIndex]["ctakesReturned"]);
									console.log("Equality:");
									console.log(typeof filesArray[tempFileIndex]["removed"] == "undefined");
									console.log("Equality:");
									console.log(typeof filesArray[tempFileIndex]["ctakesReturned"] == "undefined");
